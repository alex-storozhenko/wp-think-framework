...
if ( ! class_exists( 'Think_Customize_Date_Control' ) && class_exists( 'WP_Customize_Color_Control' ) ) {
	...
	class Think_Customize_Date_Control extends WP_Customize_Color_Control {
		...
		public function render_content() {
			?>
            <div class="wp-think-framework <?php echo Think_Helper::str_snake_to_kebab( get_class( $this ) ); ?> customizer-input-area customizer-input-area-date customizer-input-area-date-<?php echo $this->id . ' ' . Think_Helper::str_snake_to_kebab( get_class( $this ) ); ?>">
