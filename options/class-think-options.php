...
if (!class_exists('Think_Options')) {
    ...
    class Think_Options implements Think_Input_Initiator
    {
        ...
        {
            wp_enqueue_style('options_style', THINK_FRAMEWORK_URI.'/options/assets/css/style.css', [], THINK_FRAMEWORK_VERSION);
            wp_enqueue_script('options_script', THINK_FRAMEWORK_URI.'/options/assets/js/theme.options.js', ['jquery'], THINK_FRAMEWORK_VERSION, true);
        }
        ...
        protected function options_page()
        {
            add_submenu_page(
                ...
                $this->slug,
                function () {
                    return Think_Options_Page_Template::render([
                        'slug'        => $this->slug,
        ...
        protected function register_setting($section_id, array $field)
        {
            ...
            register_setting($this->options_key.'_'.$section_id, $this->options_key, [
